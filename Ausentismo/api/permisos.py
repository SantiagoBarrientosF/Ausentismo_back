...
#    permission_classes = [IsAuthenticated]
   ...
   def post(self,request):
      if request.method == 'POST':
          ...
          print(request.data)
      if cedula and nombre and correo and fecha_ingreso_empresa and tipo_permiso and campaña and cargo and fecha_inicio and fecha_fin and fecha_incorporacion and observaciones and jefe :
          data  = Permisos(
             cedula = cedula,
             nombre = nombre,
             correo = correo,
